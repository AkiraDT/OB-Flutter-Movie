              ...
              children: [
                ...
                Container(
                  ...
                  child: Consumer(builder: (context, watch, widget) {
                    ...
                    return AutoSizeText(
                      state is Success
                          ? state.data.genres.elementAt(0).name
                          : '',
                      style: TextStyle(color: Color(0xffDEDDDF)),
                    );
                  }),
                ),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(right: 5),
                        child: IconButton(
                          icon: new Icon(Icons.thumb_up_alt_outlined),
                          onPressed: () => print('yeah'),
                          iconSize: 20,
                          color: Colors.grey,
                          padding: EdgeInsets.all(0),
                      ...
                      Consumer(builder: (context, watch, widget) {
                        ...
                        return AutoSizeText(
                          state is Success ? '${state.data.voteCount} Users' : '',
                          style: TextStyle(fontSize: 9, color: Colors.grey),
                        );
                      }),
                    ],
